...
def prepare_table_data_for_plot(symbol, lot_size, target_strike):
    ...
    def prep_rows(option_type, sort_desc):
        ...
        # CHANGED: use lists with raw values
        openint_list = []
        chgoi_list = []
        ...
        # CHANGED: consider only positive MONEYCOI
